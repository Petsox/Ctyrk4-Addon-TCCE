...
public class Ctyrk4EntityLocoElectricSpawnTram extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityLocoElectricSpawnTram(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricSpawnTram(World world, double d, double d1, double d2) {
        this(world);

...
public class Ctyrk4EntityLocoElectricDuewagGT6ZR extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityLocoElectricDuewagGT6ZR(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricDuewagGT6ZR(World world, double d, double d1, double d2) {
        this(world);

...
public class Ctyrk4EntityLocoSteamTitan extends SteamTrain {
	public Ctyrk4EntityLocoSteamTitan(World world) {
	...
	public Ctyrk4EntityLocoSteamTitan(World world, double d, double d1, double d2) {
		this(world);

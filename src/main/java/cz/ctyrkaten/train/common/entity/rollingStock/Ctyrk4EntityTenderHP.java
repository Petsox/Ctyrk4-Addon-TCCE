...
public class Ctyrk4EntityTenderHP extends Tender implements IInventory  {
	public int freightInventorySize;
	public int numFreightSlots;

	public Ctyrk4EntityTenderHP(World world) {
	...
	public Ctyrk4EntityTenderHP(World world, double d, double d1, double d2) {
		this(world);

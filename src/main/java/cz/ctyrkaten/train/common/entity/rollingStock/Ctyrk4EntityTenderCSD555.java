...
public class Ctyrk4EntityTenderCSD555 extends Tender implements IInventory {
	public int freightInventorySize;
	public int numFreightSlots;

	public Ctyrk4EntityTenderCSD555(World world) {
	...
	public Ctyrk4EntityTenderCSD555(World world, double d, double d1, double d2) {
		this(world);

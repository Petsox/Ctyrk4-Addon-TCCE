...
public class Ctyrk4EntityLocoDieselCD708 extends DieselTrain {
    public Ctyrk4EntityLocoDieselCD708(World world) {
        super(world, LiquidManager.dieselFilter());
        initLoco();
    }
    public Ctyrk4EntityLocoDieselCD708(World world, double d, double d1, double d2){
        this(world);

...
public class Ctyrk4EntityLocoElectricCD151 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD151(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD151(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoElectricCD242 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD242(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD242(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityPassengerCD680Tail extends EntityRollingStock implements IPassenger {

    public Ctyrk4EntityPassengerCD680Tail(World world) {
        super(world);
    }

    public Ctyrk4EntityPassengerCD680Tail(World world, double d, double d1, double d2){
        this(world);

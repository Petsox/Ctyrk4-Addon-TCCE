...
public class Ctyrk4EntityLocoElectricZSSK131 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricZSSK131(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricZSSK131(World world, double d, double d1, double d2) {
		this(world);

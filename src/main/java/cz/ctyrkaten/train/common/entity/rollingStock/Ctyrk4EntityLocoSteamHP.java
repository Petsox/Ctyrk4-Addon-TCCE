...
public class Ctyrk4EntityLocoSteamHP extends SteamTrain {
	public Ctyrk4EntityLocoSteamHP(World world) {
	...
	public Ctyrk4EntityLocoSteamHP(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoElectricCD100 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD100(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD100(World world, double d, double d1, double d2) {
		this(world);

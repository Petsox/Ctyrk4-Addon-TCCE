...
public class Ctyrk4EntityCD127Motor extends Freight implements IInventory  {
    public int freightInventorySize;
    public int numFreightSlots;
    public Ctyrk4EntityCD127Motor(World world) {
        super(world);
        initFreightCart();
    }

    public Ctyrk4EntityCD127Motor(World world, double d, double d1, double d2){
        this(world);

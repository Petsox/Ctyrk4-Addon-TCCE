...
public class Ctyrk4EntityLocoElectricCD460 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD460(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD460(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoElectricCDAfmpz extends ElectricTrain {
	//public TiltingHandler tiltingHandler = new TiltingHandler(7);

	public Ctyrk4EntityLocoElectricCDAfmpz(World world) {
		super(world);

	}

	public Ctyrk4EntityLocoElectricCDAfmpz(World world, double d, double d1, double d2) {
		this(world);

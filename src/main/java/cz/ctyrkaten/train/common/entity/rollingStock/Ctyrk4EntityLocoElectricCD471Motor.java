...
public class Ctyrk4EntityLocoElectricCD471Motor extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD471Motor(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD471Motor(World world, double d, double d1, double d2) {
		this(world);

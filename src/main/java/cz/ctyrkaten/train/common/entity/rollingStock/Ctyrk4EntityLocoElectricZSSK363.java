...
public class Ctyrk4EntityLocoElectricZSSK363 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricZSSK363(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricZSSK363(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoSteamA16 extends SteamTrain {
	public Ctyrk4EntityLocoSteamA16(World world) {
	...
	public Ctyrk4EntityLocoSteamA16(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityPropaganda extends EntityRollingStock {


	public Ctyrk4EntityPropaganda(World world) {
		super(world);
	}

	public Ctyrk4EntityPropaganda(World world, double d, double d1, double d2) {
		this(world);

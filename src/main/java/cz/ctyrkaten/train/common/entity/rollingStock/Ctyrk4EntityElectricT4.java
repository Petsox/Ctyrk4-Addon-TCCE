...
public class Ctyrk4EntityElectricT4 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityElectricT4(World world) {
        super(world);

    }

    public Ctyrk4EntityElectricT4(World world, double d, double d1, double d2) {
        this(world);

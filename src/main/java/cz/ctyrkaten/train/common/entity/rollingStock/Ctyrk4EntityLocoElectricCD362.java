...
public class Ctyrk4EntityLocoElectricCD362 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD362(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD362(World world, double d, double d1, double d2) {
		this(world);

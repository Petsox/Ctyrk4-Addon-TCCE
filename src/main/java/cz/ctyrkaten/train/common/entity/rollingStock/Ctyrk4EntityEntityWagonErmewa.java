...
public class Ctyrk4EntityEntityWagonErmewa extends LiquidTank {
	public int freightInventorySize;

	public Ctyrk4EntityEntityWagonErmewa(World world) {
		super(world);
		initFreightWater();
	}
	...
	public Ctyrk4EntityEntityWagonErmewa(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoElectricZSSK362 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricZSSK362(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricZSSK362(World world, double d, double d1, double d2) {
		this(world);

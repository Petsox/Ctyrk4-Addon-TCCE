...
public class Ctyrk4EntityLocoElectricCD169 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityLocoElectricCD169(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricCD169(World world, double d, double d1, double d2) {
        this(world);

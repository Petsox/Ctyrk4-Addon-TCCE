...
public class Ctyrk4EntityLocoElectricCD651Loco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityLocoElectricCD651Loco(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricCD651Loco(World world, double d, double d1, double d2) {
        this(world);

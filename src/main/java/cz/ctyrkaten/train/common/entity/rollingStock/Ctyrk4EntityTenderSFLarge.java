...
public class Ctyrk4EntityTenderSFLarge extends Tender implements IInventory {
	public int freightInventorySize;
	public int numFreightSlots;

	public Ctyrk4EntityTenderSFLarge(World world) {
	...
	public Ctyrk4EntityTenderSFLarge(World world, double d, double d1, double d2) {
		this(world);
	...
	public String getInventoryName() {
		return "Southfield Large Tender";
	}

...
public class Ctyrk4EntityLocoElectricCD844 extends ElectricTrain {

    public Ctyrk4EntityLocoElectricCD844(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricCD844(World world, double d, double d1, double d2) {
        this(world);

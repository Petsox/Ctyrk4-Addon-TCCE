...
public class Ctyrk4EntityElectricCDBFHPVEE295 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityElectricCDBFHPVEE295(World world) {
        super(world);

    }

    public Ctyrk4EntityElectricCDBFHPVEE295(World world, double d, double d1, double d2) {
        this(world);

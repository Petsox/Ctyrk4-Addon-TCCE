...
public class Ctyrk4EntityLocoElectricZSSKC131 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricZSSKC131(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricZSSKC131(World world, double d, double d1, double d2) {
		this(world);

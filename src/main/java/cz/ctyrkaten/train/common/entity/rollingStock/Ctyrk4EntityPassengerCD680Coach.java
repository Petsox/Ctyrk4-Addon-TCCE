...
public class Ctyrk4EntityPassengerCD680Coach extends EntityRollingStock implements IPassenger {

    public Ctyrk4EntityPassengerCD680Coach(World world) {
        super(world);
    }

    public Ctyrk4EntityPassengerCD680Coach(World world, double d, double d1, double d2){
        this(world);

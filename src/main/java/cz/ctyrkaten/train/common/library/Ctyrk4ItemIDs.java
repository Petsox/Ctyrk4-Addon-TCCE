...
public enum Ctyrk4ItemIDs {
	...
	minecartCSD464("ItemRollingStock", "CSD464", 10),
	...
	minecartCD680Loco("ItemRollingStock", "CD_680_Loco", 2),
	minecartCD680Coach("ItemRollingStock", "CD_680_Coach", 2),
	minecartCD680Tail("ItemRollingStock", "CD_680_Tail", 2),
	minecartCD715("ItemRollingStock", "CD_715", 2),
	minecartCDZAS30("ItemRollingStock", "Zas_30", 2),

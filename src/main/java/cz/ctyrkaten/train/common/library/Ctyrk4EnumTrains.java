...
public enum Ctyrk4EnumTrains implements TrainRecord {
	...
	locoCD111("Loco Electric CD 111", Ctyrk4EntityLocoElectricCD111.class, Ctyrk4ItemIDs.locoCD111.item,"electric",1186,81,0,8,0,170,0.66,0.96,8000,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Orange", "Green", "Red", "Yellow"}),15,-2.35, Constants.TOOLTIP),

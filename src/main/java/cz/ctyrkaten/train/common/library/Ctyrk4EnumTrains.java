...
public enum Ctyrk4EnumTrains implements TrainRecord {
	...
	locoDieselGP40("Loco Diesel CD742", Ctyrk4EntityLocoDieselCD742.class,  Ctyrk4ItemIDs.minecartCD742.item, "diesel", 1200, 91,
			0, 50, 0, 250, 0.8, 0.966, 10000, TraincraftUtil.getBytesFromColors(new String[] { "Yellow", "White", "Blue", "Orange", "LightBlue", "Green", "Lime", "Red" }), 15, -2.5, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),

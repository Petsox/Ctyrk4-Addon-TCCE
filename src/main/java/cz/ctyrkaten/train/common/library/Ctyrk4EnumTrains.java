...
public enum Ctyrk4EnumTrains implements TrainRecord {
	...
	passengerCDB249("Passenger CD B249", Ctyrk4EntityPassengerCDB249.class, Ctyrk4ItemIDs.minecartCDB249.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Green", "Lime"}), 18, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoDieselGP40("Loco Diesel CD742", Ctyrk4EntityLocoDieselCD742.class,  Ctyrk4ItemIDs.minecartCD742.item, "diesel", 1200, 91,
			0, 50, 0, 250, 0.8, 0.966, 10000, TraincraftUtil.getBytesFromColors(new String[] { "Yellow", "White", "Blue", "Orange", "LightBlue", "Green", "Lime", "Red", "Grey" }), 15, -2.5, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoDieselCD754("Loco Diesel CD 754", Ctyrk4EntityLocoDieselCD754.class, Ctyrk4ItemIDs.minecartCD754.item, "diesel",
			1985, 101, 0, 40, 0, 100, 0.8, 0.97, 12000,TraincraftUtil.getBytesFromColors(new String[]{"Red", "Cyan", "Orange", "Green", "Yellow", "Lime", "Grey", "Blue"}), 10, -4.2, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoDieselCD720("Loco Diesel CD 720",Ctyrk4EntityLocoDieselCD720.class ,Ctyrk4ItemIDs.minecartCD720.item, "diesel",
			750,61,0,40,0,100,0.8,0.97,12000,TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Red", "Blue", "Green", "Lime"}),15,-2.2, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoElectricCD362("Loco Electric CD362", Ctyrk4EntityLocoElectricCD362.class, Ctyrk4ItemIDs.minecartLocoCD362.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "Yellow", "LightBlue", "Pink", "Brown"}), 18, -4, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoElectricCD363("Loco Electric CD363", Ctyrk4EntityLocoElectricCD363.class, Ctyrk4ItemIDs.minecartLocoCD363.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Red", "LightBlue"}), 18, -4, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoCD100("Loco Electric CD 100", Ctyrk4EntityLocoElectricCD100.class, Ctyrk4ItemIDs.locoCD100.item,"electric",4188,51,0,8,0,170,0.66,0.96,8000,TraincraftUtil.getBytesFromColors(new String[] {"Green"}),15,-3.8, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoCD140("Loco Electric CD 140", Ctyrk4EntityLocoElectricCD140.class, Ctyrk4ItemIDs.locoCD140.item,"electric",4188,121,0,8,0,170,0.66,0.96,8000,TraincraftUtil.getBytesFromColors(new String[] {"Green", "Blue", "LightBlue"}),15,-3.8, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoElectricRenfeCD471Motor("Loco Electric CD471 Motor", Ctyrk4EntityLocoElectricCD471Motor.class, Ctyrk4ItemIDs.minecartLocoCD471Motor.item, "electric", 2719, 141, 0, 3, 0,230, 1.4, 0.98, 0, TraincraftUtil.getBytesFromColors(new String[]{"White", "Blue", "Grey"}), 10,  -3.6, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	passengerCD471Coach("Passenger CD471 Coach", Ctyrk4EntityPassengerCD471Coach.class, Ctyrk4ItemIDs.minecartPassengerCD471Coach.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"White", "Blue", "Grey"}), 10, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	cabooseCD471Tail("Passenger CD471 Tail", Ctyrk4EntityCabooseCD471Tail.class, Ctyrk4ItemIDs.minecartCabooseCD471Tail.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"White", "Blue", "Grey"}), 10, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),

	locoElectricCD470Motor("Loco Electric CD470 Motor", Ctyrk4EntityLocoElectricCD470Motor.class, Ctyrk4ItemIDs.minecartLocoCD470Motor.item, "electric", 2654, 121, 0, 3, 0,230, 1.4, 0.98, 0, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Blue"}), 10,  -3.6, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	passengerCD470Coach("Passenger CD470 Coach", Ctyrk4EntityPassengerCD470Coach.class, Ctyrk4ItemIDs.minecartPassengerCD470Coach.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Blue"}), 10, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoCD854("CD854 Driving Motor", Ctyrk4EntityLocoDieselCD854.class, Ctyrk4ItemIDs.minecartCD854.item, "diesel", 810, 121, 0, 60, 0, 200, 0.8, 0.97, 6000, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Blue", "Orange"}), 10, -6, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoCD954("CD954 Driving Motor", Ctyrk4EntityLocoDieselCD954.class, Ctyrk4ItemIDs.minecartCD954.item, "diesel", 810, 121, 0, 60, 0, 200, 0.8, 0.97, 6000, TraincraftUtil.getBytesFromColors(new String[]{"Red"}), 10, -5.8, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoCD460("Loco 460", Ctyrk4EntityLocoElectricCD460.class, Ctyrk4ItemIDs.minecartCD460.item, "electric", 2719, 111, 0, 35, 0,230, 1.4, 0.98, 0, TraincraftUtil.getBytesFromColors(new String[]{"Purple", "Green"}), 10,  -3.6, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	passengerCD460("Passenger 060", Ctyrk4EntityPassengerCD460Coach.class, Ctyrk4ItemIDs.minecartCD060.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Lime"}), 10, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	locoCD810("CD810 Driving Motor", Ctyrk4EntityLocoDieselCD810.class, Ctyrk4ItemIDs.minecartCD810.item, "diesel", 210, 81, 0, 60, 0, 200, 0.8, 0.97, 6000, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Red", "Yellow", "Green", "Pink", "White", "Orange", "Grey", "Magenta", "LightGrey", "LightBlue", "Lime"}), 10, -2.0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	passengerCD010("CD010 Trailer", Ctyrk4EntityPassengerCD010.class, Ctyrk4ItemIDs.minecartCD010.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Red", "Yellow", "Green", "Pink", "White", "Grey", "Orange"}), 10, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	CD704("CD704", Ctyrk4EntityLocoDieselCD704.class, Ctyrk4ItemIDs.minecartCD704.item, "diesel", 340, 61, 0, 45, 0, 200, 0.87, 0.93, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "Yellow"}), 10, -1.15, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	CDEAS11("CD EAs 11", Ctyrk4EntityFreightCDEAS11.class, Ctyrk4ItemIDs.minecartCDEAS11.item, "freight", 3.5, TraincraftUtil.getBytesFromColors(new String[]{"Brown", "Red"}), 18, 36,"Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	CDBDMTEE("CDBDMTEE", Ctyrk4EntityPassengerCDBDMTEE.class, Ctyrk4ItemIDs.minecartCDBDMTEE.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Green"}),0,0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	locoElectricCD680("CD680 Loco", Ctyrk4EntityLocoElectricCD680.class, Ctyrk4ItemIDs.minecartCD680Loco.item, "electric", 6840, 260, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue"}), 18, -5.1,"Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	passengerCD680Coach("CD680 Coach", Ctyrk4EntityPassengerCD680Coach.class, Ctyrk4ItemIDs.minecartCD680Coach.item, "passenger", 0, 0, 4, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue"}), 0, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	cabooseCD680Tail("CD680 Tail", Ctyrk4EntityPassengerCD680Tail.class, Ctyrk4ItemIDs.minecartCD680Tail.item, "passenger", 0, 0, 4, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue"}), 0, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	...
	CDZAS30("Zas 30", Ctyrk4EntityCDZAS30.class, Ctyrk4ItemIDs.minecartCDZAS30.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 50000, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "White"}), 18, 0, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	CDNP("CD NP", Ctyrk4EntityCDNP.class, Ctyrk4ItemIDs.minecartCDNP.item, "freight", 5, TraincraftUtil.getBytesFromColors(new String[]{"Brown"}), 18, 36, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	CDKNS("CD KNS", Ctyrk4EntityCDKNS.class, Ctyrk4ItemIDs.minecartCDKNS.item, "freight", 4, TraincraftUtil.getBytesFromColors(new String[]{"Red"}), 18, 45, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),
	CDES11("CD ES11", Ctyrk4EntityCDES11.class, Ctyrk4ItemIDs.minecartCDES11.item, "freight", 3.5, TraincraftUtil.getBytesFromColors(new String[]{"Brown"}), 18, 45, "Pack: " + EnumChatFormatting.YELLOW + "Ctyrk4 Pack"  + EnumChatFormatting.GOLD + EnumChatFormatting.BOLD + "  -Petsox"),

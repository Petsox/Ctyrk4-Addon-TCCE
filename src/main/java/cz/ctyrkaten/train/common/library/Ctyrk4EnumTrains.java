...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_CD751("locoDieselCD751", "Loco Diesel CD 751", Ctyrk4EntityLocoDieselCD751.class, Ctyrk4ItemIDs.minecartCD751.item, "diesel",
            1985, 101, 0, 40, 0, 100, 0.8, 0.97, 12000, new String[]{"Red-CD", "Red-Cargo", "Blue-CD", "Blue-Cargo", "Grey" , "KZC", "Yellow-CD", "Yellow-Cargo", "Green", "Pruhy", "ZSSK"}, 10, -4.2, Constants.TOOLTIP),
    LOCO_CD754("locoDieselCD754", "Loco Diesel CD 754", Ctyrk4EntityLocoDieselCD754.class, Ctyrk4ItemIDs.minecartCD754.item, "diesel",
            1985, 101, 0, 40, 0, 100, 0.8, 0.97, 12000, new String[]{"Red", "Cyan", "Orange", "Green", "Yellow", "Jozko", "Lime", "Grey", "LightBlue", "CD-Cargo2", "Blue", "Bleskovka"}, 10, -4.2, Constants.TOOLTIP),
    ...
    LOCO_CD362("locoElectricCD362", "Loco Electric CD362", Ctyrk4EntityLocoElectricCD362.class, Ctyrk4ItemIDs.minecartLocoCD362.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Red","Blue", "Blue2", "Yellow", "LightBlue", "Pink", "Brown", "Green", "Najbrt1-"}, 18, -4.25, Constants.TOOLTIP),
    ...
    LOCO_CD111("locoCD111", "Loco Electric CD 111", Ctyrk4EntityLocoElectricCD111.class, Ctyrk4ItemIDs.locoCD111.item, "electric", 1186, 81, 0, 8, 0, 170, 0.66, 0.96, 8000, new String[]{"Blue", "Orange", "Orange2", "Green", "Green2", "Red", "Yellow", "Najbrt", "Najbrt2", "Najbrt3", "CargoRed"}, 15, -2.35, Constants.TOOLTIP),
    ...
    LOCO_CD383("CD383", "CD383", Ctyrk4EntityLocoElectricCD383.class, Ctyrk4ItemIDs.minecartCD383.item, "electric", 7885, 201, 0, 10, 0, 0, 0.9, 0.79, 0, new String[]{"Red", "Orange", "UniPetrol", "Yellow", "Magenta", "LightBlue", "Blue", "OBB", "Grey", "Cargo Modra", "Cargo Dual", "MRCE", "RunCzech", "BilyCD"}, 10, -3.7, Constants.TOOLTIP),
    ...
    //LOCO_CD708("CD708", "CD708", Ctyrk4EntityLocoDieselCD708.class, Ctyrk4ItemIDs.minecartCD708.item, "diesel", 340, 61, 0, 45, 0, 200, 0.87, 0.93, 16000, new String[]{"Red"}, 10, -1.15, Constants.TOOLTIP),
    ...
    FREIGHT_CDZAS30("CDZAS30", "Zas 30", Ctyrk4EntityCDZAS30.class, Ctyrk4ItemIDs.minecartCDZAS30.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 50000, new String[]{"Blue", "White", "Yellow"}, 18, 0, Constants.TOOLTIP),
    ...
    LOCO_CD1216("locoCD1216", "Loco CD 1216", Ctyrk4EntityLocoElectricCD1216.class, Ctyrk4ItemIDs.locoCD1216.item, "electric", 6400, 231, 0, 6, 0, 170, 0.9, 0.965, 0, new String[]{"Najbrt"}, 18, -5, Constants.TOOLTIP),
    ...
    LOCO_CD163("locoElectricCD163", "Loco Electric CD163", Ctyrk4EntityLocoElectricCD163.class, Ctyrk4ItemIDs.minecartLocoCD163.item, "electric", 4446, 121, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Green"}, 18, -4.25, Constants.TOOLTIP),
    LOCO_CD263("locoElectricCD263", "Loco Electric CD263", Ctyrk4EntityLocoElectricCD263.class, Ctyrk4ItemIDs.minecartLocoCD263.item, "electric", 4446, 121, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Red", "Red2"}, 18, -4.25, Constants.TOOLTIP),
    ...
    PASSENGER_CDAMPZ("passengerCDAMPZ", "Passenger CD AMPZ", Ctyrk4EntityPassengerCDAMPZ.class, Ctyrk4ItemIDs.minecartCDAMPZ.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Blue146"}, 18, 0, Constants.TOOLTIP),

...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_CD650("CD650", "CD 650", Ctyrk4EntityLocoElectricCD650Loco.class, Ctyrk4ItemIDs.minecartCD650.item, "electric", 1849, 161, 0, 10, 0, 0, 0.9, 0.9, 0, new String[]{"Blue", "Red"}, 10, -4.5, Constants.TOOLTIP),
    LOCO_CD651("CD651", "CD 651", Ctyrk4EntityLocoElectricCD651Loco.class, Ctyrk4ItemIDs.minecartCD651.item, "electric", 1849, 161, 0, 10, 0, 0, 0.9, 0.9, 0, new String[]{"Blue", "Red"}, 10, -4.7, Constants.TOOLTIP),
    PASSENGER_CD652("CD652", "CD 652", Ctyrk4EntityPassengerCD652.class, Ctyrk4ItemIDs.minecartCD652.item, "passenger", 0, 0, 1.5, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Red"}, 0, 0, Constants.TOOLTIP),

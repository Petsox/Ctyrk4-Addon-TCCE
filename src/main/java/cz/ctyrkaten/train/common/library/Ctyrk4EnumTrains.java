...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_CD362("locoElectricCD362", "Loco Electric CD362", Ctyrk4EntityLocoElectricCD362.class, Ctyrk4ItemIDs.minecartLocoCD362.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Red", "Blue", "Yellow", "LightBlue", "Pink", "Brown", "Green", "Najbrt1-"}, 18, -4.25, Constants.TOOLTIP),
    ...
    LOCO_ZSSKC131("locoZSSKC131", "Loco Electric ZSSKC 131", Ctyrk4EntityLocoElectricZSSKC131.class, Ctyrk4ItemIDs.minecartZSSKC131.item, "electric", 3046, 101, 0, 8, 0, 400, 1.1, 0.956, 0, new String[]{"Green"}, 14, -2.3, Constants.TOOLTIP),

...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_CD680("locoElectricCD680", "CD680 Loco", Ctyrk4EntityLocoElectricCD680.class, Ctyrk4ItemIDs.minecartCD680Loco.item, "electric", 6840, 260, 0, 60, 0, 100, 0.7, 0.8, 1000, new String[]{"Blue", "White"}, 18, -5.1, Constants.TOOLTIP),
    ...
    LOCO_CDAfmpz("locoCDAfmpz", "Loco CD Afmpz", Ctyrk4EntityLocoElectricCDAfmpz.class, Ctyrk4ItemIDs.locoCDAfmpz.item, "electric", 1438, 178, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Najbrt"}, 18, -4, Constants.TOOLTIP),
    ...
    LOCO_CSD477("locoSteamCSD477", "CSD 477", Ctyrk4EntityLocoSteamCSD477.class, Ctyrk4ItemIDs.minecartCSD477.item,
            "steam", 2102, 111, 0, 60, 180, 160, 0.7, 0.97, 10000, new String[]{"LightBlue",}, 7, -6.86, Constants.TOOLTIP),

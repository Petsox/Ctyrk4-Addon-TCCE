...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_ZSSKC131("locoZSSKC131", "Loco Electric ZSSKC 131", Ctyrk4EntityLocoElectricZSSKC131.class, Ctyrk4ItemIDs.minecartZSSKC131.item, "electric", 3046, 101, 0, 8, 0, 400, 1.1, 0.956, 0, new String[]{"Green"}, 14, -3.8, Constants.TOOLTIP),
    ...
    LOCO_CD163("locoElectricCD163", "Loco Electric CD163", Ctyrk4EntityLocoElectricCD163.class, Ctyrk4ItemIDs.minecartLocoCD163.item, "electric", 4446, 121, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Green", "Najbrt"}, 18, -4.25, Constants.TOOLTIP),
    ...
    LOCO_CD770("locoDieselCD770", "Loco Diesel CD770", Ctyrk4EntityLocoDieselCD770.class, Ctyrk4ItemIDs.minecartCD770.item, "diesel",
            1985, 101, 0, 40, 0, 100, 0.8, 0.97, 12000, new String[]{"Green"}, 10, -4.8, Constants.TOOLTIP),
    LOCO_CD844("CD844", "CD844", Ctyrk4EntityLocoElectricCD844.class, Ctyrk4ItemIDs.minecartCD844.item, "electric", 7885, 201, 0, 10, 0, 0, 0.9, 0.79, 0, new String[]{"Najbrt_A", "Najbrt_B"}, 10, -3.7, Constants.TOOLTIP),

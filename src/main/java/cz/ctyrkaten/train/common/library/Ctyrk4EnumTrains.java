...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_CD810("locoCD810", "CD810 Driving Motor", Ctyrk4EntityLocoDieselCD810.class, Ctyrk4ItemIDs.minecartCD810.item, "diesel", 210, 81, 0, 60, 0, 200, 0.8, 0.97, 6000, new String[]{"Blue", "Red", "Yellow", "ODS", "Green", "Pink", "White", "Orange", "Grey", "Magenta", "LightGrey", "LightBlue", "Lime"}, 10, -2.0, Constants.TOOLTIP),
    ...
    LOCO_CD844("CD844", "CD844", Ctyrk4EntityLocoDieselCD844.class, Ctyrk4ItemIDs.minecartCD844.item, "diesel", 523, 121, 0, 10, 0, 0, 0.9, 0.79, 0, new String[]{"Najbrt_A", "Najbrt_B"}, 10, -3.7, Constants.TOOLTIP),

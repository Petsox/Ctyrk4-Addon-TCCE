...
public enum Ctyrk4EnumTrains {
    ...
    LOCO_ZSSK361("locoElectricZSSK361", "Loco Electric ZSSK361", Ctyrk4EntityLocoElectricZSSK361.class, Ctyrk4ItemIDs.minecartZSSK361.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Red", "Blue"}, 18, -4.25, Constants.TOOLTIP),
    ...
    LOCO_CD362("locoElectricCD362", "Loco Electric CD362", Ctyrk4EntityLocoElectricCD362.class, Ctyrk4ItemIDs.minecartLocoCD362.item, "electric", 4446, 141, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Red", "Blue", "Yellow", "LightBlue", "Pink", "Brown"}, 18, -4.25, Constants.TOOLTIP),
    LOCO_CD363("locoElectricCD363", "Loco Electric CD363", Ctyrk4EntityLocoElectricCD363.class, Ctyrk4ItemIDs.minecartLocoCD363.item, "electric", 4446, 121, 0, 10, 0, 170, 0.7, 0.965, 6850, new String[]{"Blue", "Red", "LightBlue"}, 18, -4.25, Constants.TOOLTIP),
    ...
    LOCO_CD111("locoCD111", "Loco Electric CD 111", Ctyrk4EntityLocoElectricCD111.class, Ctyrk4ItemIDs.locoCD111.item, "electric", 1186, 81, 0, 8, 0, 170, 0.66, 0.96, 8000, new String[]{"Blue", "Orange", "Orange2", "Green", "Red", "Yellow", "Najbrt", "Najbrt2"}, 15, -2.35, Constants.TOOLTIP),
    ...
    LOCO_CD854("locoCD854", "CD854 Driving Motor", Ctyrk4EntityLocoDieselCD854.class, Ctyrk4ItemIDs.minecartCD854.item, "diesel", 810, 121, 0, 60, 0, 200, 0.8, 0.97, 6000, new String[]{"Red", "Orange", "Blue"}, 10, -6.2, Constants.TOOLTIP),

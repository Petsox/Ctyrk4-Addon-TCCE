...
public class ModelCD460_Loco extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public ModelCD460_Loco() //Same as Filename
	{
	...
	cz.ctyrkaten.train.client.render.models.Model440R_Truck bogie = new Model440R_Truck();

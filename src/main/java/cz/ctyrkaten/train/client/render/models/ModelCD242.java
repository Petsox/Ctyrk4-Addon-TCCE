...
public class ModelCD242 extends ModelConverter
{
	int textureX = 512;
	int textureY = 256;
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CD242_bogie.png"));
		GL11.glPushMatrix();

...
import train.client.render.models.ModelFMTrimountTruck;

import java.util.ArrayList;

public class ModelCD770 extends ModelConverter //Same as Filename
{

	int textureX = 512;
	int textureY = 512;

	public ModelCD770() //Same as Filename
	{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor() == 4){
			Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CD_770_bogie1.png"));
			GL11.glPushMatrix();
			...
			Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CD_770_bogie2.png"));
			GL11.glPushMatrix();
			GL11.glRotatef(180, 0, 1, 0);
			GL11.glTranslated(-1.52, -0.03, 0);
			theTruc.render(entity, f, f1, f2, f3, f4, f5);//rear truck

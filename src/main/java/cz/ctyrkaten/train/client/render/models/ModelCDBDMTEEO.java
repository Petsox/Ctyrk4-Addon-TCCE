...
import train.client.render.models.ModelGs4Bogie;

public class ModelCDBDMTEEO extends ModelBase
{
	int textureX = 512;
	int textureY = 512;

	public ModelCDBDMTEEO()
	{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if(entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor()==2){
			Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CDBDMTEEO_bogie_Red.png"));
		} else {
			Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CDBDMTEEO_bogie.png"));
		}
		GL11.glPushMatrix();

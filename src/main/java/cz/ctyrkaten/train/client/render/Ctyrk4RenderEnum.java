...
public enum Ctyrk4RenderEnum implements TrainRenderRecord {
	...
	locoCD362WTB(Ctyrk4EntityLocoElectricCD362WTB.class, new ModelCD362WTB(), "CD362WTB_", true, new float[]{-2.125F,0.18F,0}, new float[] { 0F, 180F, 180F }, new float[]{0.9f,1f,0.9f}, "",0,null, "", null, 0, false),
	...
	CDNPPLEKS(Ctyrk4EntityNPPLEKS.class, new ModelNPPLEKS(), "NPPLEKS_", true, new float[] { 0.0F, -0.44F, 0.0F }, null, null, "", 0, null, "", null, 0, false),
	...
	locoCD162(Ctyrk4EntityLocoElectricCD162.class, new ModelCD362(), "CD162_", true, new float[]{-2.125F,0.18F,0}, new float[] { 0F, 180F, 180F }, new float[]{0.9f,1f,0.9f}, "",0,null, "", null, 0, false),
	locoCD162WTB(Ctyrk4EntityLocoElectricCD162WTB.class, new ModelCD362WTB(), "CD162WTB_", true, new float[]{-2.125F,0.18F,0}, new float[] { 0F, 180F, 180F }, new float[]{0.9f,1f,0.9f}, "",0,null, "", null, 0, false),
	...
	LOCO_HP(Ctyrk4EntityLocoSteamHP.class, new ModelBR_Britannia_Class(), "HP_LOCO_", true, new float[]{-2.3f, -0.05f, 0}, new float[]{0, 180, 180}, null, "largesmoke", 3, new ArrayList<double[]>() {
		{
	...
	TENDER_HP(Ctyrk4EntityTenderHP.class, new ModelBR1_Tender(), "HP_TENDER_", true, new float[]{0f, -0.01f, 0f,}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
	HP_COACH(Ctyrk4EntityPassengerHPCoach.class, new ModelBR_Mk1_TSO(), "HP_COACH_", true, new float[]{0, 0, 0,}, new float[]{0, 180, 180}, null, "", 0, null, "", null, 0, false),

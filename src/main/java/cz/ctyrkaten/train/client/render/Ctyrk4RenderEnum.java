...
public enum Ctyrk4RenderEnum implements TrainRenderRecord {
	...
	ClassA16tender(Ctyrk4EntityTenderA16.class, new ModelA16Tender(), "A16_Tender_", true,
			new float[] { 0.0F, 0.1F, 0.0F }, new float[] { 180F, 0.0F, 0.0F },new float[] { 1F, 1F, 0.9F }, "", 0, null, "", null, 0, false),
	ClassA16Loco(Ctyrk4EntityLocoSteamA16.class, new ModelA16Loco(), "A16_", true,
			new float[] { -4.5F, 0.1F, 0.0F }, new float[] { 180F, 180F, 0.0F },new float[] { 1F, 1F, 0.9F }, "largesmoke", 3, new ArrayList<double[]>() {
		{
			add(new double[] { 7.6D, 1.75D, 0.0D });
		}
	}, "explode", new ArrayList<double[]>() {
		{
			add(new double[] { 7.8D, -0.2D, 0.8D });
		}
	}, 2, false),

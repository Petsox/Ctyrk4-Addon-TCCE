...
public class ModelCD720 extends ModelBase
{
    int textureX = 512;
    int textureY = 128;
    private ModelMILW_CD720_Bogie trucks = new ModelMILW_CD720_Bogie();
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/CD720_bogie.png"));

...
import train.client.render.models.ModelFreightTruckM;
...
public class ModelPropagandaCar extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		Tessellator.bindTexture(new ResourceLocation(Ctyrk4AddonInfo.resourceLocation, "textures/trains/propaganda_bogie.png"));

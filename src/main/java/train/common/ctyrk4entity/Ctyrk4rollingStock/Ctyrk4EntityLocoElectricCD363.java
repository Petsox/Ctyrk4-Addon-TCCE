...
public class Ctyrk4EntityLocoElectricCD363 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD363(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD363(World world, double d, double d1, double d2) {
		this(world);

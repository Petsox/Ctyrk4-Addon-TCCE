...
public class Ctyrk4EntityLocoDieselCD812 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD812(World world) {
	...
	public Ctyrk4EntityLocoDieselCD812(World world, double d, double d1, double d2) {
		this(world);

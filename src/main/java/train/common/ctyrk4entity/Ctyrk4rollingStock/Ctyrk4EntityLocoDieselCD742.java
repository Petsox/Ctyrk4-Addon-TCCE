...
public class Ctyrk4EntityLocoDieselCD742 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD742(World world) {
	...
	public Ctyrk4EntityLocoDieselCD742(World world, double d, double d1, double d2) {
		this(world);

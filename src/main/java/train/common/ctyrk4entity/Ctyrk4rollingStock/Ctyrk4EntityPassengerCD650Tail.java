...
public class Ctyrk4EntityPassengerCD650Tail extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityPassengerCD650Tail(World world) {
        super(world);
    }

    public Ctyrk4EntityPassengerCD650Tail(World world, double d, double d1, double d2){
        this(world);

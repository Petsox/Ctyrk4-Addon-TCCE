...
public class Ctyrk4EntityLocoDieselCD770 extends DieselTrain {
    public Ctyrk4EntityLocoDieselCD770(World world) {
        super(world, Ctyrk4EnumTrains.CD770.getTankCapacity(), LiquidManager.dieselFilter());
        initLoco();
    }
    public Ctyrk4EntityLocoDieselCD770(World world, double d, double d1, double d2){
        this(world);

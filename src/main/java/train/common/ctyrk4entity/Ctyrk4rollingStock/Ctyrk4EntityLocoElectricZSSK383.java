...
public class Ctyrk4EntityLocoElectricZSSK383 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityLocoElectricZSSK383(World world) {
        super(world);

    }

    public Ctyrk4EntityLocoElectricZSSK383(World world, double d, double d1, double d2) {
        this(world);

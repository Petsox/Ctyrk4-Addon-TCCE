...
public class Ctyrk4EntityLocoDieselCD843 extends DieselTrain {
    public Ctyrk4EntityLocoDieselCD843(World world) {
        super(world, Ctyrk4EnumTrains.locoCD843.getTankCapacity(), LiquidManager.dieselFilter());
        initLoco();

    }
    public Ctyrk4EntityLocoDieselCD843(World world, double d, double d1, double d2){
        this(world);

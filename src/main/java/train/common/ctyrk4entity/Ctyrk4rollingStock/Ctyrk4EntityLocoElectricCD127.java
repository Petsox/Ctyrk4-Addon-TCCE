...
public class Ctyrk4EntityLocoElectricCD127 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD127(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD127(World world, double d, double d1, double d2) {
		this(world);
	...
	public void updateRiderPosition() {
		TraincraftUtil.updateRider(this, 1.6, 0.0);
	}

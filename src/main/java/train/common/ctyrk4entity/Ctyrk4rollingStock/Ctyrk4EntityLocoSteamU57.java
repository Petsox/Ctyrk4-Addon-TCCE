...
public class Ctyrk4EntityLocoSteamU57 extends SteamTrain {
	...
	public Ctyrk4EntityLocoSteamU57(World world, double d, double d1, double d2) {
		this(world);
	...
	public void updateRiderPosition() {
		...
		riddenByEntity.setPosition(posX - 0.2, posY + getMountedYOffset() + riddenByEntity.getYOffset() + 0.3F, posZ + 0.5F);
	}

...
public class Ctyrk4EntityLocoElectricZSSK350 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricZSSK350(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricZSSK350(World world, double d, double d1, double d2) {
		this(world);

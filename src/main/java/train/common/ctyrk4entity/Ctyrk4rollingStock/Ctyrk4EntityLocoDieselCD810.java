...
public class Ctyrk4EntityLocoDieselCD810 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD810(World world) {
	...
	public Ctyrk4EntityLocoDieselCD810(World world, double d, double d1, double d2) {
		this(world);

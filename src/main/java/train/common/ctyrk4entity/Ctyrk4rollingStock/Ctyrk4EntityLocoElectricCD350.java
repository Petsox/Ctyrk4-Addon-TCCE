...
public class Ctyrk4EntityLocoElectricCD350 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD350(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD350(World world, double d, double d1, double d2) {
		this(world);

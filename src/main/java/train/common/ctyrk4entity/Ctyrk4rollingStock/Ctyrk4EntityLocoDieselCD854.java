...
public class Ctyrk4EntityLocoDieselCD854 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD854(World world) {
		super(world, Ctyrk4EnumTrains.locoCD814.getTankCapacity(), LiquidManager.dieselFilter());
		initLoco();
	}
	...
	public Ctyrk4EntityLocoDieselCD854(World world, double d, double d1, double d2) {
		this(world);

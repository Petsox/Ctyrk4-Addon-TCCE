...
public class Ctyrk4EntityLocoDieselCD814 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD814(World world) {
	...
	public Ctyrk4EntityLocoDieselCD814(World world, double d, double d1, double d2) {
		this(world);

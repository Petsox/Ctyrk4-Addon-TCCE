...
public class Ctyrk4EntityLocoElectric8171MLoco extends ElectricTrain {
	public Ctyrk4EntityLocoElectric8171MLoco(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectric8171MLoco(World world, double d, double d1, double d2) {
		this(world);

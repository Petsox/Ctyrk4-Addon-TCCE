...
public class Ctyrk4EntityLocoElectricCD111 extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD111(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD111(World world, double d, double d1, double d2) {
		this(world);

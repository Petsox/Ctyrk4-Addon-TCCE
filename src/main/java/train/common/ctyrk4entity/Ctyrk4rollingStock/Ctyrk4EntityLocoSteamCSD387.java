...
public class Ctyrk4EntityLocoSteamCSD387 extends SteamTrain {
	public Ctyrk4EntityLocoSteamCSD387(World world) {
	...
	public Ctyrk4EntityLocoSteamCSD387(World world, double d, double d1, double d2) {
		this(world);

...
public class Ctyrk4EntityLocoDieselCD754 extends DieselTrain {
	public Ctyrk4EntityLocoDieselCD754(World world) {
	...
	public Ctyrk4EntityLocoDieselCD754(World world, double d, double d1, double d2) {
		this(world);

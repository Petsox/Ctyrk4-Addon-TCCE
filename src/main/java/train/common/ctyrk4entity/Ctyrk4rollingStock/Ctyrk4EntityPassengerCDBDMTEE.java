...
public class Ctyrk4EntityPassengerCDBDMTEE extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public Ctyrk4EntityPassengerCDBDMTEE(World world) {
        super(world);
    }

    public Ctyrk4EntityPassengerCDBDMTEE(World world, double d, double d1, double d2){
        this(world);

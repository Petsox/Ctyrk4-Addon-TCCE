...
public class Ctyrk4EntityLocoElectricCD451Motor extends ElectricTrain {
	public Ctyrk4EntityLocoElectricCD451Motor(World world) {
		super(world);
	}

	public Ctyrk4EntityLocoElectricCD451Motor(World world, double d, double d1, double d2) {
		this(world);

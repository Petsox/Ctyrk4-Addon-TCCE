...
public class Ctyrk4EntityLocoDieselCD704 extends DieselTrain {
    public Ctyrk4EntityLocoDieselCD704(World world) {
        super(world, Ctyrk4EnumTrains.CD704.getTankCapacity(), LiquidManager.dieselFilter());
        initLoco();
    }
    public Ctyrk4EntityLocoDieselCD704(World world, double d, double d1, double d2){
        this(world);

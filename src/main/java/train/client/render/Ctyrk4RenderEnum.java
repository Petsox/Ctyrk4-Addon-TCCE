...
import train.client.render.models.ModelCD010;
import train.client.render.models.ModelCD014;
import train.client.render.models.ModelCD754;
import train.client.render.models.ModelCD810;
import train.client.render.models.ModelCD814;
import train.client.render.models.ModelCD914;
import train.client.render.models.ModelGP40;
import train.client.render.models.ModelLocoCD151;
import train.client.render.models.ModelLocoU57;
import train.common.api.EntityRollingStock;
import tmt.ModelBase;

import java.util.ArrayList;

public enum Ctyrk4RenderEnum {
	//Ctyrk4 Pack
	...
	locoCD720(Ctyrk4EntityLocoDieselCD720.class, new ModelCD720(), "CD_720_", true, new float[]{0,0.06f,0}, new float[] { 0F, 180F, 180F }, new float[]{0.9f,1f,0.9f}, "largesmoke", 4, new ArrayList<double[]>() {
		{
	...
	locoCD854(Ctyrk4EntityLocoDieselCD854.class, new ModelCD854(), "CD854", false, new float[] { -1.4F, 0.15F, -0.68F }, new float[] { 0F, 180F, 180F }, null, "", 0, null, "", null, 0, false),

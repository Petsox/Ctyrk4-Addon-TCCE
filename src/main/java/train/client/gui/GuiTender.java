...
public class GuiTender extends GuiContainer {
	...
	private train.common.api.Tender tender;
	...
	public GuiTender(EntityPlayer player, InventoryPlayer inventoryplayer, Entity entityminecart) {
		super(new InventoryTender(inventoryplayer, (train.common.api.Tender) entityminecart));
						...
						for (Object entity : lis3) {
							if (entity instanceof EntityPlayer) {
								Ctyrk4_Addon_TCCE.lockChannel
										.sendToServer(new train.common.core.network.PacketSetTrainLockedToClient(true, tender.getEntityId()));
							}
						}
					}
					tender.locked = true;
	...
	protected void drawGuiContainerBackgroundLayer(float f, int t, int g) {
		String i = Ctyrk4AddonInfo.guiPrefix + "gui_tender.png";
